using LiteBus.Mediator.UnitTests.UseCases.Events.UseCases;
using LiteBus.Mediator.UnitTests.UseCases.Events.UseCases.EventWithNoHandlers;
using LiteBus.Mediator.UnitTests.UseCases.Events.UseCases.EventWithTag;
using LiteBus.Mediator.UnitTests.UseCases.Events.UseCases.ProblematicEvent;
using LiteBus.Mediator.UnitTests.UseCases.Events.UseCases.ProductCreated;
using LiteBus.Mediator.UnitTests.UseCases.Events.UseCases.ProductUpdated;
using LiteBus.Mediator.UnitTests.UseCases.Events.UseCases.ProductViewed;
