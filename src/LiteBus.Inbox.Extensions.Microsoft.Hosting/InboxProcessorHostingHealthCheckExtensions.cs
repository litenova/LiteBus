...
/// <summary>
///     Registers LiteBus inbox processor health checks with Microsoft health-check hosting.
/// </summary>
public static class InboxProcessorHostingHealthCheckExtensions
{
    /// <summary>
    ///     Adds a health check that reports inbox processor host state.
    /// </summary>
    ...
    public static IHealthChecksBuilder AddLiteBusInboxProcessor(
        this IHealthChecksBuilder builder,
        string name = "litebus.inbox.processor")
    {
        ArgumentNullException.ThrowIfNull(builder);

        return builder.AddCheck<InboxProcessorHealthCheck>(
            name,
