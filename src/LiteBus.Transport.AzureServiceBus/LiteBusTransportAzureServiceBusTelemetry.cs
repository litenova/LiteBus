...
///     <c>LiteBus.Transport</c> meter. Call <c>AddMeter(LiteBusTransportAzureServiceBusTelemetry.MeterName)</c> only when you
///     add custom Azure instrumentation.
/// </remarks>
public static class LiteBusTransportAzureServiceBusTelemetry
{
    /// <summary>
