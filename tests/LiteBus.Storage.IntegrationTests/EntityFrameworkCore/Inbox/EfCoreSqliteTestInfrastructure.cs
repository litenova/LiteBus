...
/// <summary>
///     Creates and resets file-backed SQLite inbox stores for shared contract tests.
/// </summary>
internal static class EfCoreSqliteTestInfrastructure
{
    ...
    internal static IntegrationInboxDbContext CreateContext(string connectionString)
    {
        ...
        return new IntegrationInboxDbContext(builder.Options, StoreOptions, EfCoreStorageProvider.Sqlite);
    }

    /// <summary>
    ///     Creates the inbox table once and removes rows before a contract test.
    /// </summary>
    /// <param name="connectionString">The SQLite connection string.</param>
