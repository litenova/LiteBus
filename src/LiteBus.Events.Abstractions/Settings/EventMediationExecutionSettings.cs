...
/// <remarks>
/// <para>
/// Execution settings control the concurrency and ordering behavior of event handlers organized into priority groups.
...
/// <list type="bullet">
/// <item>
/// <description><strong>Priority Group Level:</strong> Controls how different priority groups execute relative to each other (sequential vs parallel)</description>
/// </item>
/// <item>
/// <description><strong>Handler Level:</strong> Controls how handlers within the same priority group execute (sequential vs parallel)</description>
/// </item>
/// </list>
/// <para>
