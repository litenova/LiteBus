...
/// <summary>
///     Accumulates per-pass outcome counts during a single inbox processor iteration.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    ///     The identifiers of envelopes that completed successfully during the pass.
    /// </summary>
    ...
    /// </summary>
    private readonly List<InboxEnvelopeFailure> _failures = [];

    /// <summary>
    ///     The dead-letter transitions collected during the pass.
    /// </summary>
    private readonly List<InboxEnvelopeDeadLetter> _deadLetters = [];

    /// <summary>
    ///     Gets the identifiers of envelopes that completed successfully during the pass.
    /// </summary>
    ...
    /// </summary>
    public IReadOnlyList<InboxEnvelopeFailure> Failures => _failures;

    /// <summary>
    ///     Gets the dead-letter transitions collected during the pass.
    /// </summary>
    public IReadOnlyList<InboxEnvelopeDeadLetter> DeadLetters => _deadLetters;

    /// <summary>
    ///     Records one successful envelope outcome.
    /// </summary>
    /// <param name="messageId">The identifier of the envelope that completed.</param>
    ...
    public void RecordFailure(InboxEnvelopeFailure failure) =>
    ...
    public void RecordDeadLetter(InboxEnvelopeDeadLetter deadLetter) =>
