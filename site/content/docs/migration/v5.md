...
// v6: inbox.UsePostgreSqlStorage(pg => pg.UseDataSource(dataSource)) inside AddInbox.
...
// v6: outbox.UsePostgreSqlStorage(...) and outbox.UseInProcessDispatch() inside AddOutbox.
