...
public static class ModuleRegistryHostingExtensions
{
    ...
    /// <remarks>
    ///     <para>
    ///         Call <see cref="Outbox.Storage.PostgreSql.ModuleRegistryExtensions.AddPostgreSqlOutboxStorage" /> first and set
    ...
    ///     </para>
    /// </remarks>
    public static IModuleRegistry AddPostgreSqlOutboxStorageSchemaHosting(this IModuleRegistry moduleRegistry)
    {
