    ...
    IMessageMediationStrategy<TMessage, IAsyncEnumerable<TMessageResult>> where TMessage : notnull
{
    ...
    /// <remarks>
    ///     The mediation process includes:/// 1. Executing pre-handlers before starting the stream. /// 2. Obtaining the
    ///     stream from the handler. /// 3. Enumerating the stream and yielding each result. /// 4. Executing post-handlers
