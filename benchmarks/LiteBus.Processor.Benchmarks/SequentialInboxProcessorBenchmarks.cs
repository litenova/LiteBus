...
/// <summary>
///     Measures sequential <see cref="LegacySequentialInboxProcessor" /> throughput at realistic handler latencies.
/// </summary>
[MemoryDiagnoser]
[SimpleJob(warmupCount: 3, iterationCount: 10)]
public class SequentialInboxProcessorBenchmarks
{
    /// <summary>
    ...
    /// <summary>
    ///     The sequential processor under measurement.
    /// </summary>
    private LegacySequentialInboxProcessor _processor = null!;
    ...
    public void Setup()
    {
        ...
        _processor = new LegacySequentialInboxProcessor(
            _store,
            dispatcher,
            new InboxProcessorOptions
            {
                BatchSize = BatchSize,
                LeaseOwner = "benchmark-worker",
        ...
        {
            _store.EnqueueAsync(new InboxEnvelope
            {
                Id = Guid.NewGuid(),
    ...
    /// <summary>
    ///     Processes one full batch through the sequential inbox processor.
    /// </summary>
    /// <returns>A task that completes when the pass finishes.</returns>
    [Benchmark(Description = "Sequential inbox processor pass")]
