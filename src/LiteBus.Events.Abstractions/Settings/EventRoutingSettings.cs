...
/// </remarks>
public sealed record EventRoutingSettings
{
    /// <summary>
    ///     Gets the collection of tags used to filter event handlers.
    /// </summary>
    /// <value>
    ...
    /// <summary>
    ///     Gets a predicate function used to filter event handlers by their descriptor.
    /// </summary>
    /// <value>
    ///     An <see cref="EventHandlerFilter" /> that determines which handlers should execute.
    ...
    /// </remarks>
    public EventHandlerFilter HandlerPredicate { get; init; } = _ => true;
}
