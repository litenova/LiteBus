...
/// <summary>
///     Tracks runtime state from the inbox processor background service for health checks.
/// </summary>
public sealed class InboxProcessorHostState
{
    /// <summary>
    ...
    /// <summary>
    ///     Records a host-level failure that occurred outside individual message handling.
    /// </summary>
