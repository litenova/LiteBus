...
public sealed class InboxModuleBuilder
{
    ...
    /// <summary>
    ///     Feature bridge sub-modules registered for this inbox.
    /// </summary>
    private readonly List<IModule> _featureBridgeModules = [];
    ...
    public InboxModuleBuilder RegisterSaga(IModule sagaModule)
    {
        ...
        _featureBridgeModules.Add(sagaModule);
        return this;
    }
    ...
    public IReadOnlyList<IModule> CollectSubModules()
    {
        ...
        modules.AddRange(_featureBridgeModules);
        return modules;
    }
