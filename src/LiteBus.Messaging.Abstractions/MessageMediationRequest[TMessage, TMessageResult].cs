...
/// <summary>
///     Represents request data that controls the behavior of the message mediation process.
/// </summary>
...
/// <remarks>
///     These settings allow customizing various aspects of the mediation process, such as
///     how message types are resolved, which mediation strategy is used, and what tags are applied
///     for filtering handlers. Cancellation is passed separately on <see cref="IMessageMediator.Mediate" />.
/// </remarks>
public sealed record MessageMediationRequest<TMessage, TMessageResult> where TMessage : notnull
{
    /// <summary>
