...
/// <remarks>
///     Return <see cref="Verdict.Deny" /> to deny the command, which the mediation reports as
///     <see cref="MediationOutcome.Denied" /> and an audit trail records as a denial, or <see cref="Verdict.Allow" /> to
///     let it proceed. This contract fits every command, including one that produces a result, because a denial does
