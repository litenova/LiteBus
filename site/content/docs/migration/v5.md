...
This guide covers the upgrade from v4.4.0 to v5.0. **New projects should start on [Migration Guide v6](v6.md)** (current v6 schemas, nested module builders, `AcceptAsync` / `EnqueueAsync`). This page remains for teams stepping through historical v4 to v5 upgrades only.
