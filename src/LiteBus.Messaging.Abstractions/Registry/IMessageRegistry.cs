...
/// <summary>
/// Defines the contract for a message registry that manages handler registration and provides access to registered messages.
/// </summary>
public interface IMessageRegistry : System.Collections.Generic.IReadOnlyCollection<IMessageDescriptor>
{
    /// <summary>
    ...
    /// </remarks>
    System.Collections.Generic.IReadOnlyList<IHandlerDescriptor> Handlers { get; }
