...
| --- | --- | --- |
| v5.x to v6.0 | Greenfield durable messaging: nested module builders, `AcceptAsync` / `EnqueueAsync`, pipelined processors, PostgreSQL schema v1, `net10.0` only. See the v6 guide for rename tables when upgrading application code from pre-v6 package versions. | [Migration Guide v6](v6.md) |
