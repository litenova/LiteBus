using LiteBus.Mediator.UnitTests.UseCases.Commands.UseCases;
using LiteBus.Mediator.UnitTests.UseCases.Commands.UseCases.CommandWithTag;
using LiteBus.Mediator.UnitTests.UseCases.Commands.UseCases.CreateProduct;
using LiteBus.Mediator.UnitTests.UseCases.Commands.UseCases.LogActivity;
using LiteBus.Mediator.UnitTests.UseCases.Commands.UseCases.ProblematicCommand;
using LiteBus.Mediator.UnitTests.UseCases.Commands.UseCases.UpdateProduct;
    ...
    public async Task Send_CreateProductCommand_ShouldGoThroughHandlersCorrectly()
    {
        ...
        var serviceProvider = new ServiceCollection()
            .AddLiteBus(registry =>
            {
                ...
                {
                    builder.RegisterFromCommandsTestAssembly();
                });
            })
