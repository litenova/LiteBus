...
///     </para>
///     <code><![CDATA[
/// EventHandlerFilter validationOnly = descriptor => 
...
///     </para>
///     <code><![CDATA[
/// EventHandlerFilter skipAuditInDev = descriptor => 
...
///     </para>
///     <code><![CDATA[
/// EventHandlerFilter emergencyMode = descriptor => 
///     isEmergencyMode 
...
///     </para>
///     <code><![CDATA[
/// EventHandlerFilter featureFlagFilter = descriptor => 
...
///     </para>
///     <code><![CDATA[
/// EventHandlerFilter coreModulesOnly = descriptor => 
...
///     </para>
///     <code><![CDATA[
/// EventHandlerFilter complexBusinessLogic = descriptor => 
/// {
...
///     </para>
///     <code><![CDATA[
/// EventHandlerFilter integrationTestFilter = descriptor => 
///     isIntegrationTest 
...
///     </para>
///     <code><![CDATA[
/// EventHandlerFilter orderSpecificHandlers = descriptor => 
...
/// EventHandlerFilter combined = descriptor => 
...
/// {
///     public static EventHandlerFilter ByNamespace(string namespacePrefix) =>
///         descriptor => descriptor.HandlerType.Namespace?.StartsWith(namespacePrefix) == true;
///     
///     public static EventHandlerFilter ByTag(string tag) =>
...
/// EventHandlerFilter circuitBreakerFilter = descriptor =>
/// {
...
/// EventHandlerFilter abTestFilter = descriptor =>
/// {
...
/// EventHandlerFilter tenantFilter = descriptor =>
/// {
...
/// ]]></code>
/// </example>
public delegate bool EventHandlerFilter(IHandlerDescriptor descriptor);