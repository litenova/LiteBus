...
///     Call <c>AddMeter(LiteBusTransportKafkaTelemetry.MeterName)</c> only when you add custom Kafka instrumentation.
/// </remarks>
public static class LiteBusTransportKafkaTelemetry
{
    /// <summary>
