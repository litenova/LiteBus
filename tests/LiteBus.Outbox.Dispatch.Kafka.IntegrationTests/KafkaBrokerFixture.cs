...
/// <summary>
///     xUnit collection fixture that shares one Kafka container for outbox dispatch integration tests.
/// </summary>
...
/// <summary>
///     Serializes Kafka outbox dispatch integration tests that share one broker container.
/// </summary>
...
public sealed class KafkaBrokerCollection : ICollectionFixture<KafkaBrokerFixture>
{
    ...
    /// </summary>
    public const string Name = "Kafka.Outbox.Dispatch";
}
