...
/// <summary>
///     Renews inbox leases on an interval while dispatch work is still running.
/// </summary>
internal static class ProcessorLeaseHeartbeat
{
    /// <summary>
    ///     Runs an inbox operation and renews the active lease on a background loop until the operation completes.
    /// </summary>
