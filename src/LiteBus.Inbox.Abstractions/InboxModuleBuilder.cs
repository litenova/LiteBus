...
public sealed class InboxModuleBuilder
{
    ...
    /// </summary>
    private readonly List<IModule> _ingressModules = [];
    ...
    /// <returns>The current builder.</returns>
    public InboxModuleBuilder RegisterStorage(IModule storageModule)
    {
    ...
    /// <returns>The current builder.</returns>
    public InboxModuleBuilder RegisterDispatcher(IModule dispatcherModule)
    {
    ...
    /// <returns>The current builder.</returns>
    public InboxModuleBuilder RegisterIngress(IModule ingressModule)
    {
