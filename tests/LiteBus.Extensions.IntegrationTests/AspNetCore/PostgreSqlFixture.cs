...
namespace LiteBus.Extensions.IntegrationTests.AspNetCore;

/// <summary>
///     Shared PostgreSQL container for ASP.NET Core management endpoint integration tests.
/// </summary>
public sealed class PostgreSqlFixture : IAsyncLifetime
{
    ...
    /// <summary>
    ///     Gets the shared PostgreSQL data source used by inbox storage registrations.
    /// </summary>
