...
/// <summary>
/// Represents an asynchronous post-handler that acts upon messages of a specified type, facilitating additional operations or transformations to be conducted asynchronously on the results produced from the primary message handling process.
/// </summary>
/// <typeparam name="TMessage">The type of the message being handled, defining the structural context for the message involved in the post-handling process.</typeparam>
/// <typeparam name="TMessageResult">The type of the result produced from the initial handling of the message, informing the kind of data that can be worked upon in the asynchronous post-handling process.</typeparam>
/// <remarks>
...
public interface IAsyncMessagePostHandler<in TMessage, in TMessageResult> : IMessagePostHandler<TMessage, TMessageResult>
{
    ...
    /// <summary>
    /// Orchestrates the asynchronous execution of actions after the message has been handled, allowing for the implementation of post-processing logic that operates over both the handled message and its initial result with the flexibility of asynchronous programming.
    /// </summary>
    /// <param name="message">The handled message, which is the focal point for the post-handling actions, offering a structured data set for asynchronous operations.</param>
