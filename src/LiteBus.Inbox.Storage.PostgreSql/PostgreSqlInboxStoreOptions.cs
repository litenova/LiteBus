...
public sealed record PostgreSqlInboxStoreOptions : PostgreSqlSchemaStoreOptions, IPostgreSqlStoreTableOptions, IMessageStoreRetentionOptions
{
    ...
    /// </summary>
    /// <remarks>
    ///     When <see langword="true" />, <see cref="PostgreSqlInboxSchemaInitializer" /> creates or upgrades schema on host
    ///     startup.
    ...
    ///     <see
    ///         cref="PostgreSqlInboxSchema.ValidateAsync(Npgsql.NpgsqlDataSource, PostgreSqlInboxStoreOptions?, System.Threading.CancellationToken)" />
